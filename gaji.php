...
<?php require ('navbar.php');?>  
   ...
   <!-- Content Row -->
          <div class="row">
			...
			<button type="button" class="btn btn-success" style="margin:5px" data-toggle="modal" data-target="#myModalTambah"><i class="fa fa-plus">  Pembayaran Gaji</i></button><br>
           <!-- DataTales Example -->
	<div class="row">
		<div class="col-xl-8 col-lg-7">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Transaksi Pembayaran Gaji</h6>
            </div>
            <div class="card-body">
...
<form role="form" action="proses-edit-gaji.php" method="get">

<?php
$id = $data['id_pengeluaran']; 
$query_edit = mysqli_query($koneksi,"SELECT * FROM gaji WHERE id_pengeluaran='$id'");
...
<a href="hapus-gaji.php?id_pengeluaran=<?=$row['id_pengeluaran'];?>" Onclick="confirm('Anda Yakin Ingin Menghapus?')" class="btn btn-danger">Hapus</a>
  ...
  <div id="myModalTambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <!-- body modal -->
		<form action="tambah-gaji.php" method="get">
        <div class="modal-body">
		Tanggal : 
