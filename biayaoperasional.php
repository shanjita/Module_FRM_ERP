...
<?php require ('navbar.php');?>  
   ...
   <!-- Content Row -->
          <div class="row">
			...
			<button type="button" class="btn btn-success" style="margin:5px" data-toggle="modal" data-target="#myModalTambah"><i class="fa fa-plus">  Pembayaran Operasional</i></button><br>
           <!-- DataTales Example -->
	<div class="row">
		<div class="col-xl-8 col-lg-7">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Transaksi Pembayaran Biaya Operasional</h6>
            </div>
            <div class="card-body">
...
?>
                    <tr>
                      <td><?=$data['id_biayaoperasional']?></td>
                      <td><?=$data['nama_biaya']?></td>
                      <td><?=$data['tanggal']?></td>
                      <td>Rp. <?=number_format($data['jumlah'],2,',','.');?></td>
					  <td>
                    <!-- Button untuk modal -->
<a href="#" type="button" class=" fa fa-edit btn btn-primary btn-md" data-toggle="modal" data-target="#myModal<?php echo $data['id_biayaoperasional']; ?>"></a>
</td>
</tr>
<!-- Modal Edit Mahasiswa-->
<div class="modal fade" id="myModal<?php echo $data['id_biayaoperasional']; ?>" role="dialog">
<div class="modal-dialog">

<!-- Modal content-->
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title">Ubah Data Biaya Operasional</h4>
<button type="button" class="close" data-dismiss="modal">&times;</button>
</div>
<div class="modal-body">
<form role="form" action="proses-edit-biayaoperasional.php" method="get">

<?php
$id = $data['id_biayaoperasional']; 
$query_edit = mysqli_query($koneksi,"SELECT * FROM biayaoperasional WHERE id_biayaoperasional='$id'");
//$result = mysqli_query($conn, $query);
while ($row = mysqli_fetch_array($query_edit)) {  
?>


<input type="hidden" name="id_biayaoperasional" value="<?php echo $row['id_biayaoperasional']; ?>">

<div class="form-group">
<label>No</label>
<input type="text" name="id_biayaoperasional" class="form-control" value="<?php echo $row['id_biayaoperasional']; ?>" disabled>      
</div>

<div class="form-group">
<label>Nama Operasional</label>
<input type="text" name="nama_biaya" class="form-control" value="<?php echo $row['nama_biaya']; ?>">      
</div>
...
<a href="hapus-biayaoperasional.php?id_biayaoperasional=<?=$row['id_biayaoperasional'];?>" Onclick="confirm('Anda Yakin Ingin Menghapus?')" class="btn btn-danger">Hapus</a>
  ...
  <div id="myModalTambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <!-- body modal -->
		<form action="tambah-biayaoperasional.php" method="get">
        <div class="modal-body">
        Nama Operasional : 
