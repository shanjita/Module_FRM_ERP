  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="http://127.0.0.1:8000/beranda">
          <i class="fas fa-fw fa-arrow-up"></i>
          <span>UNILEVER</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="gaji.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="bahanbaku.php" >
          <i class="fas fa-fw fa-arrow-down"></i>
          <span>Pembelian Bahan Baku</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="biayaOperasional.php" >
          <i class="fas fa-fw fa-arrow-down"></i>
